...
/*
  Logic:
  The logic is that we don't need to sort the complete array, that's wastage of resource
  as we need only the kth greatest number.
  So we will randomly pick a pivot and reorder the array in a way that numbers greater than
  it are to the left and smaller than it are to the right
  Doing this we will find our answer when our pivotIndex comes to be k-1 because then to the left
  only k-1 elements will be greater (their particular order doesn't matter to us)
*/
/*
